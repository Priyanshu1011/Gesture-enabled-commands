#hibernate #fist with thumb in
#logoff #spidy
#shutdown #fist with thumb out
#restart #spidy thumb in
import cv2
                ...
                for handLMS in results.multi_hand_landmarks:
                    ...
                    if ((indexY < handBottomY) and (indexY > indexmid)) and ((middleY < handBottomY) and (middleY > midmid)) and ((ringY < handBottomY) and (ringY > ringmid)) and ((pinkyY < handBottomY) and (pinkyY > pinkymid)) and (thumbx <= thumbmid) :
                        ...
                        if counter>3:
                            ...
                            quit()
                    elif ((indexY < handBottomY) and (indexY > indexmid)) and ((middleY < handBottomY) and (middleY > midmid)) and ((ringY < handBottomY) and (ringY > ringmid)) and ((pinkyY < handBottomY) and (pinkyY > pinkymid)) and (thumbx > thumbmid) :
                        #global counter
                        cv2.rectangle(handsFrame, (indexX, indexY), (pinkyX, handBottomY), (0, 0, 255), 2)
                        cv2.putText(handsFrame, pext, (pinkyX + 2, indexY - 2), (font), .7,(0, 0, 255), 1, cv2.LINE_4)
                        counter+=1
                        if counter>3:
                            ...
                            quit()
                    elif (indexY < indexmid) and ((middleY < handBottomY) and (middleY > midmid)) and ((ringY < handBottomY) and (ringY > ringmid)) and (pinkyY < pinkymid) and (thumbx < thumbmid) :
                        #global counter
                        cv2.rectangle(handsFrame, (indexX, indexY), (pinkyX, handBottomY), (0, 0, 255), 2)
                        cv2.putText(handsFrame, pext, (pinkyX + 2, indexY - 2), (font), .7,(0, 0, 255), 1, cv2.LINE_4)
                        counter+=1
